...
(function (MEO) {
  ...
  function mergeSingleton(local, remote) {
    // profile/settings são objetos únicos (não listas). Usa updatedAt de cada um
    // para decidir qual versão é mais recente; sem updatedAt, mescla campo a campo
    // preferindo o remoto apenas onde o local está vazio.
