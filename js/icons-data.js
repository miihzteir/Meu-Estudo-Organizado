...
(function (MEO) {
  ...
  const I = {
    ...
    'list-checks': '<polyline points="3.5,6 5,7.5 8,4.5"/><line x1="11" y1="6" x2="21" y2="6"/><polyline points="3.5,13 5,14.5 8,11.5"/><line x1="11" y1="13" x2="21" y2="13"/><polyline points="3.5,20 5,21.5 8,18.5"/><line x1="11" y1="20" x2="21" y2="20"/>',
    'square': '<rect x="4" y="4" width="16" height="16" rx="3"/>',
    'circle': '<circle cx="12" cy="12" r="9"/>',
    'flag': '<path d="M5 21V4"/><path d="M5 4.5c1.6-1.2 3.3-1.2 5 0s3.4 1.2 5 0v9c-1.6 1.2-3.3 1.2-5 0s-3.4-1.2-5 0Z"/>',
    'tag': '<path d="M11.5 3.5H5a1.5 1.5 0 0 0-1.5 1.5v6.5c0 .4.2.8.4 1.1l9 9a1.5 1.5 0 0 0 2.1 0l6.5-6.5a1.5 1.5 0 0 0 0-2.1l-9-9c-.3-.3-.7-.5-1-.5Z"/><circle cx="8.2" cy="8.2" r="1.3" fill="currentColor" stroke="none"/>',
    'copy': '<rect x="8.5" y="8.5" width="12" height="12" rx="2"/><path d="M15.5 8.5V5.5a2 2 0 0 0-2-2H5.5a2 2 0 0 0-2 2v8a2 2 0 0 0 2 2h3"/>',
    'users': '<path d="M11 21v-1.5a4.5 4.5 0 0 0-4.5-4.5H5a4.5 4.5 0 0 0-4.5 4.5V21"/><circle cx="7.2" cy="8.2" r="3.8"/><path d="M15.5 3.4a3.8 3.8 0 0 1 0 7.4"/><path d="M18 14.4a4.5 4.5 0 0 1 4.5 4.5V21"/>',
    'target': '<circle cx="12" cy="12" r="9"/><circle cx="12" cy="12" r="5.2"/><circle cx="12" cy="12" r="1.3" fill="currentColor" stroke="none"/>',
    'star': '<path d="M12 2.5l2.9 6.1 6.6.8-4.9 4.6 1.3 6.6L12 17.6l-5.9 3 1.3-6.6-4.9-4.6 6.6-.8Z"/>',
    'notebook-text': '<path d="M6 3h13a1 1 0 0 1 1 1v16a1 1 0 0 1-1 1H6a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2Z"/><line x1="8" y1="7" x2="16" y2="7"/><line x1="8" y1="11" x2="16" y2="11"/><line x1="8" y1="15" x2="13" y2="15"/><line x1="2.5" y1="6" x2="2.5" y2="9"/><line x1="2.5" y1="11.5" x2="2.5" y2="14.5"/><line x1="2.5" y1="17" x2="2.5" y2="20"/>',
    'pin': '<path d="M12 2 9 5v6l-4 4v2h5.5l1.5 6 1.5-6H19v-2l-4-4V5Z"/>',
    'user-plus': '<path d="M13 21v-1.5A4.5 4.5 0 0 0 8.5 15H6a4.5 4.5 0 0 0-4.5 4.5V21"/><circle cx="7.2" cy="8.2" r="3.8"/><line x1="18" y1="9" x2="18" y2="15"/><line x1="15" y1="12" x2="21" y2="12"/>',
    'inbox': '<path d="M3.5 12.5h5l1.7 3h3.6l1.7-3h5"/><path d="M6 5h12l2.5 7.5v7a1.5 1.5 0 0 1-1.5 1.5h-14A1.5 1.5 0 0 1 3.5 19.5v-7Z"/>'
  };
  ...
  MEO.refreshIcons = function (root) {
    ...
    scope.querySelectorAll('i[data-lucide]').forEach(el => {
      ...
      // Preserva o "style" inline do <i> original (ex.: cor customizada de um
      // tipo de evento) — sem isso a troca por <svg> perdia esse estilo.
